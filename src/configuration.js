const {
  REACT_APP_ENVIRONMENT = 'localhost', // optional, have to set to production
...
const configurations = {
  localhost: {
    ...
    foreignNodeConnection: 'http://localhost:8546', // I have to change this to my Metamask account
  ...
  // I HAVE TO CHANGE THE PARAMETERS HERE TO MY OWN ADDRESESS
  develop: {
    title: 'develop',
